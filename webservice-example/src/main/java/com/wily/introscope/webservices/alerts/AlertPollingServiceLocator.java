...
public class AlertPollingServiceLocator extends org.apache.axis.client.Service implements com.wily.introscope.webservices.alerts.AlertPollingService {
    ...
    public AlertPollingServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for AlertPollingService
    private java.lang.String AlertPollingService_address = "http://apm-docker.ca.com:8081/introscope-web-services/services/AlertPollingService";
    ...
    public com.wily.introscope.webservices.alerts.IAlertPollingService getAlertPollingService() throws javax.xml.rpc.ServiceException {
    ...
    public com.wily.introscope.webservices.alerts.IAlertPollingService getAlertPollingService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wily.introscope.webservices.alerts.AlertPollingServiceSoapBindingStub _stub = new com.wily.introscope.webservices.alerts.AlertPollingServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.wily.introscope.webservices.alerts.IAlertPollingService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wily.introscope.webservices.alerts.AlertPollingServiceSoapBindingStub _stub = new com.wily.introscope.webservices.alerts.AlertPollingServiceSoapBindingStub(new java.net.URL(AlertPollingService_address), this);
                _stub.setPortName(getAlertPollingServiceWSDDServiceName());
                return _stub;
            }
        }
